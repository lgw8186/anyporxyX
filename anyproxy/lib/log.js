...
function printLog(content, type) {
  ...
  switch (type) {
    case LogLevelMap.tip: {
      ...
      console.log(color.cyan(`[Log][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.system_error: {
      ...
      console.error(color.red(`[ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.rule_error: {
      ...
      console.error(color.red(`[RULE_ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.warn: {
      ...
      console.error(color.yellow(`[WARN][${timeString}]: ` + content));
      break;
    }
